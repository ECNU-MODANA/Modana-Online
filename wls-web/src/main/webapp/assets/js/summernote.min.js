...
function(a) {
    ...
    k = {
        ...
        options: {
            ...
            lang: "en-US",
            direction: null,
            toolbar: [["style", ["style"]], ["font", ["bold", "italic", "underline","superscript", "subscript", "clear"]], ["fontname", ["fontname"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ["height", ["height"]], ["table", ["table"]], ["view", ["codeview","link",]], ["insert", ["picture", "video"]] ],
            airMode: !1,
        ...
        lang: {
            "en-US": {
                ...
                video: {
                    ...
                    insert: "插入视频",
                    url: "视频网址",
                    providers: "(YouTube, Vimeo, Vine, Instagram, DailyMotion 或者 优酷)"
                },
                table: {
                    table: "表格"
                },
    ...
    o = function() {
        ...
        d = function(b, h, i, k) {
            ...
            this.deleteContents = function() {
                ...
                e = j.prevPointUntil(b.getStartPoint(),
                function(a) {
    ...
    r = function() {
        ...
        this.indent = function() {
            ...
            function(c, d) {
                var e = g.head(d);
                j.isLi(e) ? b.wrapList(d, e.parentNode.nodeName) : a.each(d,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.outdent = function() {
            ...
            function(c, d) {
                var e = g.head(d);
                j.isLi(e) ? b.releaseList([d]) : a.each(d,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.toggleList = function(b) {
            ...
            if (g.find(e, j.isPurePara)) a.each(h,
            function(a, d) {
                c.wrapList(d, b)
            });
            else {
        ...
        this.releaseList = function(b, c) {
            ...
            function(b, e) {
                ...
                (c || !j.isList(i.parentNode)) && (e = a.map(e,
                function(a) {
                    return j.replace(a, "P")
                })),
                a.each(g.from(e).reverse(),
                function(a, b) {
                    j.insertAfter(b, i)
                });
    ...
    var z = function() {
        ...
        q = function(b, c) {
            ...
            d.onImageUpload ? d.onImageUpload(c, h, b) : a.each(c,
            function(a, c) {
                var e = c.name;
        ...
        r = {
            ...
            fullscreen: function(a) {
                ...
                k ? (e.data("orgheight", e.css("height")), c.on("resize",
                function() {
                    j({
                        w: c.width(),
            ...
            codeview: function(a) {
                ...
                o ? (l.val(j.html(h, !0)), l.height(h.height()), i.deactivate(g), k.hide(m), l.focus(), e.hasCodeMirror && (c = b.fromTextArea(l[0], n.codemirror), n.codemirror.tern && (d = new b.TernServer(n.codemirror.tern), c.ternServer = d, c.on("cursorActivity",
                function(a) {
                    d.updateArgHints(a)
    ...
    A = function() {
        ...
        i = function(a, e) {
            ...
            i = function() {
                ...
                f = e.airPopover.length; f > c; c++) {
                    ...
                    for (var i = 0,
                    j = g[1].length; j > i; i++) b += h[g[1][i]](a, e);
                    b += "</div>"
                }
        ...
        this.createLayoutByFrame = function(b, c) {
            ...
            for (var l = a.extend(a.summernote.lang["en-US"], a.summernote.lang[c.lang]), m = "", n = 0, o = c.toolbar.length; o > n; n++) {
                ...
                for (var r = 0,
                s = q.length; s > r; r++) a.isFunction(h[q[r]]) && (m += h[q[r]](l, c));
                m += "</div>"
            }
